...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 04, 2022 at 08:06 AM
...
(73, 45, '3170', 't', '1'),
(74, 45, '9273', 'ok', '2'),
(75, 51, '5546', 'Cần xe đến đón tận nơi\r\n', '2'),
(76, 51, '1175', 'Cần thêm 2 phòng ngủ', '2');
...
(51, 'quochuy', '123456', 'Quốc Huy', 'Khóm 4 Phường 1', '0812276763', 0);
...
--
ALTER TABLE `dondathang`
  MODIFY `madh` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=77;
...
--
ALTER TABLE `nguoidung`
  MODIFY `mand` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=57;
